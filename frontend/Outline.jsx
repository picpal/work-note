...
(function () {
  ...
  function smoothScrollTo(el, to, dur) {
    dur = dur || 320;
    ...
    el.__wnScroll = setInterval(() => {
      ...
      if (p >= 1) { clearInterval(el.__wnScroll); el.__wnScroll = 0; }
    }, 16);
  }

  function Outline({ content, title, viewRef }) {
    ...
    const offsetFor = useCallback((line) => {
