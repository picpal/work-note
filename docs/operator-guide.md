...
>
> 이전 버전은 기존 디렉토리도 말없이 `700`으로 바꿨습니다. 그 동작을 없앴기 때문에, 아래에 해당하면 **업그레이드 후 기동이 실패합니다.** 미리 확인하세요.
>
> | 상황 | 조치 |
> | --- | --- |
...
>
> 상대 경로를 막는 이유는 위치가 실행 계정의 작업 디렉토리에 따라 달라지기 때문입니다. 그대로 두면 앱이 작업 디렉토리 전체를 `700`으로 바꾸는 사고로 이어집니다.
