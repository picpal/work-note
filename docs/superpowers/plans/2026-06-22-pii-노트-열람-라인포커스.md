...
`frontend/src/styles/admin.css` 맨 끝에 추가:
...
```bash
git add frontend/src/components/PiiNoteViewer.tsx frontend/src/styles/admin.css
...
`frontend/src/styles/admin.css`에 `.click-row`가 없으면 맨 끝에 추가:
...
```bash
git add frontend/src/admin/screens/Pii.tsx frontend/src/styles/admin.css
